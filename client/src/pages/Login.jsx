    ...
    <div className="min-h-screen bg-gradient-to-br from-calljet-950 via-calljet-900 to-calljet-800 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-calljet-500 rounded-2xl mb-4">
        ...
        <div className="card p-8">
          ...
          <div className="mt-6 text-center">
            <button
              ...
              className="text-sm text-calljet-600 hover:text-calljet-700"
            >
